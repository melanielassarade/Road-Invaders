...
btnCredits.style.margin = "auto";
btnCredits.style.marginTop = "1rem";
btnCredits.style.padding = "0.5rem";
btnCredits.innerText = "Crédits";
btnCredits.style.width = "12rem";
btnCredits.style.fontFamily = "monospace";
btnCredits.style.textAlign = "center";
btnCredits.style.fontSize = "1rem";
btnCredits.style.fontWeight = "bold";
btnCredits.style.color = "#6c0c04";
btnCredits.style.backgroundColor = "rgba(0,0,0,0)";
btnCredits.style.border = "5px dashed #6c0c04";
btnCredits.style.transition = "0.5s";

btnCredits.addEventListener('mouseover', function(){
    btnCredits.style.backgroundColor = "#6c0c04";
    btnCredits.style.color = "yellow"; 
});

btnCredits.addEventListener('mouseleave', function(){
    btnCredits.style.color = "#6c0c04";
    btnCredits.style.backgroundColor = "rgba(0,0,0,0)";
});
